...
module BitbarCloudApiClient
  class APIBuildResultConfig
    attr_accessor :destination_name

    attr_accessor :directory

    attr_accessor :file_url_env_variable
    ...
    def self.attribute_map
      {
        ...
        :'directory' => :'directory',
        :'file_url_env_variable' => :'fileUrlEnvVariable',
        :'id' => :'id',
        :'self_uri' => :'selfURI',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fileUrlEnvVariable')
        self.file_url_env_variable = attributes[:'fileUrlEnvVariable']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file_url_env_variable == o.file_url_env_variable &&
          id == o.id &&
          self_uri == o.self_uri &&
    ...
    def hash
      [destination_name, directory, file_url_env_variable, id, self_uri, source_name, storage].hash
    end
