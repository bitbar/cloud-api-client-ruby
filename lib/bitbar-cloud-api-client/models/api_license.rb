  ...
  class APILicense
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BitbarCloudApiClient::APILicense` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BitbarCloudApiClient::APILicense`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'inspector')
        self.inspector = attributes[:'inspector']
      end
      ...
      if attributes.key?(:'private_instance')
        self.private_instance = attributes[:'private_instance']
      end
      ...
      if attributes.key?(:'recorder')
        self.recorder = attributes[:'recorder']
      end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('Object', ['ACTIVE', 'EXPIRED', 'INACTIVE', 'CLOSED'])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('Object', ['ACTIVE', 'EXPIRED', 'INACTIVE', 'CLOSED'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ios == o.ios &&
          private_instance == o.private_instance &&
          user_id == o.user_id &&
          recorder == o.recorder &&
          server == o.server &&
          global == o.global &&
    ...
    def hash
      [id, self_uri, android, expire_time, activate_time, close_time, desktop, inspector, ios, private_instance, user_id, recorder, server, global, build, user_email, status].hash
    end
