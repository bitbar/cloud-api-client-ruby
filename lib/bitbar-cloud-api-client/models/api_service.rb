...
module BitbarCloudApiClient
  class APIService
    ...
    def self.swagger_types
      {
        ...
        :'charge_type' => :'String',
        :'custom_plan' => :'BOOLEAN',
        :'default_concurrences' => :'Array<Integer>',
        :'description' => :'String',
        :'external_id' => :'String',
        :'id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultConcurrences')
        if (value = attributes[:'defaultConcurrences']).is_a?(Array)
    ...
    def hash
      [activate_time, activated, archive_time, auto_renew, cent_price, charge_type, custom_plan, default_concurrences, description, external_id, id, included_hours, name, price_per_hour, price_string, roles, self_uri, unit].hash
    end
