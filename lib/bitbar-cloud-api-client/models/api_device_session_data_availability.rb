...
module BitbarCloudApiClient
  class APIDeviceSessionDataAvailability
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'buildLogs')
        self.build_logs = attributes[:'buildLogs']
      end
      ...
      if attributes.has_key?(:'resultsDataZip')
        self.results_data_zip = attributes[:'resultsDataZip']
      end
    ...
    def hash
      [build_logs, device_run_id, id, logs, performance, results_data_zip, screenshots, self_uri].hash
    end
