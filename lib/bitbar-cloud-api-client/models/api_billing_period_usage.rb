...
module BitbarCloudApiClient
  class APIBillingPeriodUsage
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billableSeconds')
        self.billable_seconds = attributes[:'billableSeconds']
      end
      ...
      if attributes.has_key?(:'nonBillableSeconds')
        self.non_billable_seconds = attributes[:'nonBillableSeconds']
      end
    ...
    def hash
      [billable_seconds, id, non_billable_seconds, os_type, self_uri, type].hash
    end
