...
module BitbarCloudApiClient
  class APIBillingPeriodUsage
    ...
    attr_accessor :non_billable_seconds
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'Object',
        :'os_type' => :'Object',
        :'billable_seconds' => :'Object',
        :'non_billable_seconds' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BitbarCloudApiClient::APIBillingPeriodUsage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BitbarCloudApiClient::APIBillingPeriodUsage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'non_billable_seconds')
        self.non_billable_seconds = attributes[:'non_billable_seconds']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          non_billable_seconds == o.non_billable_seconds
    end
    ...
    def hash
      [id, self_uri, type, os_type, billable_seconds, non_billable_seconds].hash
    end
