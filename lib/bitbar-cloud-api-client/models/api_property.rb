...
module BitbarCloudApiClient
  class APIProperty
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fromTime')
      ...
      if attributes.has_key?(:'updatedByDisplayName')
        self.updated_by_display_name = attributes[:'updatedByDisplayName']
      end
    ...
    def hash
      [description, from_time, id, name, self_uri, to_time, update_time, updated_by_display_name, updated_by_id, value].hash
    end
