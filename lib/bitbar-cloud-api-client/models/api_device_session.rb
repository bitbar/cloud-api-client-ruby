...
module BitbarCloudApiClient
  class APIDeviceSession
    ...
    def hash
      [auto_retries_left_count, billable, create_time, device, device_instance_id, device_log_first_timestamp, device_run_id, device_time, duration, end_time, exclude_reason, id, install_time, launch_app_duration, name, project_id, project_name, retry_state, row_index, self_uri, start_time, state, success_ratio, test_case_all_count, test_case_failed_count, test_case_passed_count, test_case_skipped_count, test_case_success_count, test_run_id, test_run_name, time_limit, type, user_email, user_id].hash
    end
