...
module BitbarCloudApiClient
  class APIAccessGroup
    ...
    def valid?
      scope_validator = EnumAttributeValidator.new('String', ['USER', 'ACCOUNT', 'GLOBAL'])
    ...
    def scope=(scope)
      validator = EnumAttributeValidator.new('String', ['USER', 'ACCOUNT', 'GLOBAL'])
    ...
    def hash
      [id, name, scope, self_uri, user_email, user_id].hash
    end
