...
module BitbarCloudApiClient
  class APIAdminTestRun
    ...
    def hash
      [app_crawler_run, create_time, duration, end_time, framework_id, framework_name, id, message, priority, project_id, project_name, scheduler, self_uri, start_time, started_by_id, state, success_ratio, test_run_name, user_name].hash
    end
