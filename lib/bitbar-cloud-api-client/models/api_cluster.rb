...
module BitbarCloudApiClient
  class APICluster
    ...
    def self.swagger_types
      {
        :'devices' => :'APIListOfAPIAdminDevice',
        :'enabled' => :'BOOLEAN',
        :'id' => :'Integer',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pluginVersion')
        self.plugin_version = attributes[:'pluginVersion']
      end
    ...
    def hash
      [devices, enabled, id, name, plugin_version, self_uri, state, state_change_time, state_time, url].hash
    end
