...
module BitbarCloudApiClient
  class APIAdminDeviceModel
    ...
    attr_accessor :avg_waiting_time
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BitbarCloudApiClient::APIAdminDeviceModel` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BitbarCloudApiClient::APIAdminDeviceModel`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'avg_waiting_time')
        self.avg_waiting_time = attributes[:'avg_waiting_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          avg_waiting_time == o.avg_waiting_time &&
          enabled == o.enabled &&
          os_type == o.os_type &&
          platform == o.platform &&
          location == o.location &&
    ...
    def hash
      [id, self_uri, name, online, total, running, queue_size, avg_waiting_time, enabled, os_type, platform, location, dedicated, release_version].hash
    end
