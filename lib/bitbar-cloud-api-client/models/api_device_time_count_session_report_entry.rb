  ...
  class APIDeviceTimeCountSessionReportEntry
    ...
    def self.openapi_types
      {
        ...
        :'os_type' => :'Object',
        :'day' => :'Object',
        :'count_test_runs' => :'Object',
        :'count_device_sessions' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BitbarCloudApiClient::APIDeviceTimeCountSessionReportEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BitbarCloudApiClient::APIDeviceTimeCountSessionReportEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'count_test_runs')
        self.count_test_runs = attributes[:'count_test_runs']
      end

      if attributes.key?(:'count_device_sessions')
        self.count_device_sessions = attributes[:'count_device_sessions']
      end
    end
    ...
    def hash
      [self_uri, device_time, user_email, device_model_name, project_name, os_type, day, count_test_runs, count_device_sessions].hash
    end
