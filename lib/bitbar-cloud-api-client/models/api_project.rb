...
module BitbarCloudApiClient
  class APIProject
    ...
    def hash
      [archive_time, archiving_item_count, archiving_strategy, common, create_time, description, id, name, os_type, read_only, row_index, self_uri, shared, shared_by_email, shared_by_id, shared_with_caller, success_ratio, user_email, user_id].hash
    end
