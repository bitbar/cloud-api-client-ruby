...
module BitbarCloudApiClient
  class APIScreenshotExtended
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'takeTimestamp')
        self.take_timestamp = attributes[:'takeTimestamp']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['LANDSCAPE', 'PORTRAIT'])
    ...
    def hash
      [device, device_run_id, fail, id, original_name, project_id, self_uri, take_timestamp, test_run_id, type].hash
    end
