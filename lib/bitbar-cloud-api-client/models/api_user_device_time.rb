...
module BitbarCloudApiClient
  class APIUserDeviceTime
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'billableTime')
        self.billable_time = attributes[:'billableTime']
      end
      ...
      if attributes.has_key?(:'freeTime')
        self.free_time = attributes[:'freeTime']
      end
    ...
    def hash
      [billable_time, create_time, device_time, end_time, free_time, id, self_uri, type, user_id, user_name].hash
    end
