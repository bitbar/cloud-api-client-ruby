...
module BitbarCloudApiClient
  class APIActivity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deprecatedResource')
        self.deprecated_resource = attributes[:'deprecatedResource']
      end
    ...
    def hash
      [body, create_time, deprecated_resource, http_method, id, parameters, self_uri, uri, user_agent, user_email, user_id].hash
    end
