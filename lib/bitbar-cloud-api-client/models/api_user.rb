...
module BitbarCloudApiClient
  class APIUser
    ...
    def self.swagger_types
      {
        ...
        :'last_launched_test_time' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'originPortal')
        self.origin_portal = attributes[:'originPortal']
      end
      ...
      if attributes.has_key?(:'registrationIP')
        self.registration_ip = attributes[:'registrationIP']
      end
