...
module BitbarCloudApiClient
  class APIDeviceSessionStep
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'finishTimeMS')
        self.finish_time_ms = attributes[:'finishTimeMS']
      end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['WAITING', 'PREPARING', 'UNINSTALL', 'INSTALL', 'RUNNING', 'SENDING_RESULTS', 'PROCESSING_RESULTS'])
    ...
    def hash
      [device_session_id, exclude_reason, fail_reason, finish_time_ms, id, self_uri, start_time_ms, type].hash
    end
