...
module BitbarCloudApiClient
  class APIConnection
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'urlSchema')
        self.url_schema = attributes[:'urlSchema']
      end
    end
    ...
    def hash
      [create_time, device_session_id, end_time, host, id, password, path, port, self_uri, type, url, url_schema].hash
    end
