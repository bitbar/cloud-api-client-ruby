...
module BitbarCloudApiClient
  class APIAdminEmail
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastRetryTime')
        self.last_retry_time = attributes[:'lastRetryTime']
      end
    ...
    def hash
      [create_time, id, last_retry_time, self_uri, sent, subject, user_email, user_id].hash
    end
