...
module BitbarCloudApiClient
  class APIAdminDevice
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stateChangeTime')
        self.state_change_time = attributes[:'stateChangeTime']
      end
    ...
    def hash
      [account_id, cluster, device_model_id, device_model_name, enabled, fingerprint, id, init_step, ip_address, last_online_time, locked, main_user_email, name, os_type, self_uri, serial_id, software_version, state, state_change_time, state_time, unlock_gesture].hash
    end
