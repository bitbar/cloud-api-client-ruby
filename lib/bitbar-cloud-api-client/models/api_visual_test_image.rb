...
module BitbarCloudApiClient
  class APIVisualTestImage
    ...
    attr_accessor :comparison_status
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BitbarCloudApiClient::APIVisualTestImage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BitbarCloudApiClient::APIVisualTestImage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'comparison_status')
        self.comparison_status = attributes[:'comparison_status']
      end
    ...
    def valid?
      image_type_validator = EnumAttributeValidator.new('Object', ['fullpage', 'viewport', 'element screenshot'])
    ...
    def image_type=(image_type)
      validator = EnumAttributeValidator.new('Object', ['fullpage', 'viewport', 'element screenshot'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comparison_status == o.comparison_status &&
          app_url == o.app_url &&
    ...
    def hash
      [id, self_uri, image_name, image_type, image_url, image_thumbnail_url, comparison_status, app_url, session_id, test_url, created_at].hash
    end
