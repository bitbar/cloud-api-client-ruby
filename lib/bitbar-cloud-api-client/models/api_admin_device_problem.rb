...
module BitbarCloudApiClient
  class APIAdminDeviceProblem
    ...
    def self.swagger_types
      {
        ...
        :'device_name' => :'String',
        :'id' => :'Integer',
        :'problems' => :'Array<APIAdminDeviceProblemPair>',
        :'self_uri' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'problems')
    ...
    def hash
      [cluster_id, cluster_name, device_id, device_model_id, device_model_name, device_name, id, problems, self_uri].hash
    end
