...
module BitbarCloudApiClient
  class APIDeviceTimeStepTimeReportEntry
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'preparationTime')
        self.preparation_time = attributes[:'preparationTime']
      end
      ...
      if attributes.has_key?(:'waitingTime')
        self.waiting_time = attributes[:'waitingTime']
      end
    end
    ...
    def hash
      [day, device_model_name, device_time, id, os_type, preparation_time, project_name, self_uri, user_email, waiting_time].hash
    end
