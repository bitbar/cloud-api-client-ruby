...
module BitbarCloudApiClient
  class APIClientSideTestConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appiumVersion')
        self.appium_version = attributes[:'appiumVersion']
      end
    ...
    def valid?
      target_validator = EnumAttributeValidator.new('String', ['ANDROID', 'IOS', 'SELENDROID', 'SAFARI', 'CHROME', 'XCUITEST', 'DESKTOP'])
    ...
    def target=(target)
      validator = EnumAttributeValidator.new('String', ['ANDROID', 'IOS', 'SELENDROID', 'SAFARI', 'CHROME', 'XCUITEST', 'DESKTOP'])
    ...
    def hash
      [appium_version, browser_name, location, platform, screen_resolution, target, version].hash
    end
