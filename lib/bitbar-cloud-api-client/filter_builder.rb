module BitbarCloudApiClient
  class FilterBuilder
    ...
    def afterorequal(name, value)
      add(name, value, 'afterorequal', 'd')
    end
    ...
    def beforeorequal(name, value)
      add(name, value, 'beforeorequal', 'd')
    end
    ...
    def notin(name, value)
      add(name, value, 'notin', nil, true)
    end
